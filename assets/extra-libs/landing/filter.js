function filterMain(countyid, subcountyid, periodid) {
        ...
        var url = `https://hiskenya.org/api/analytics.json?dimension=pe:'+periodid+'&dimension=dx:HfGVoCZAwtd;nK8sqMAeQHY;ZcngDQJKiEg;wOKbEd8Dbi3;lHPLS1G5CUc;SSARcWY2Ge1;AX1co0SXobM;UUNwkYQhYgX&dimension=ou:'+countyid+'&displayProperty=NAME&outputIdScheme=UID`;
        ...
        var urlfa = `https://hiskenya.org/api/analytics.json?dimension=dx:HfGVoCZAwtd;nK8sqMAeQHY;ZcngDQJKiEg;wOKbEd8Dbi3;SSARcWY2Ge1;AX1co0SXobM;UUNwkYQhYgX&dimension=ou:'+countyid+';LEVEL-5&filter=pe:'+periodid+'&displayProperty=NAME&outputIdScheme=UID`;
        ...
        var urlphy = `https://hiskenya.org/api/analytics.json?dimension=dx:BnGDrFwyQp9.rPAsF4cpNxm;c0MB4RmVjxk.rPAsF4cpNxm;qnZmg5tNSMy.rPAsF4cpNxm;gVp1KSFI69G.rPAsF4cpNxm;Mmy9MoUdbhZ;iOARK31NdLp.rPAsF4cpNxm;imheYfA1Kiw.rPAsF4cpNxm;eFqDcjgvt39.ZxUQw1ay1cw&dimension=pe:'+periodid+'&filter=ou:'+countyid+'&displayProperty=NAME&outputIdScheme=UID`;
